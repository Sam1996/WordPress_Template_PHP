...
<div id="page" class="site container">
    ...
    <div class="container-fluid">
        ...
        <div class="row header">
            <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-10 logo">
                ...
                <div class="col-xs-2 smaller">
                    <span class="smaller-icon glyphicon glyphicon-menu-hamburger"></span>
                </div>
        </div>
        <div class="row">
            <nav id="site-navigation" class="" role="navigation">
                    ...
                    <div class="" id="main-navbar-collapse main-navigation ">
